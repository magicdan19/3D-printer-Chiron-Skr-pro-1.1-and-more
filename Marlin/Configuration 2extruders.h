...
#define HOTEND_OFFSET_X { 0.0, 26.30 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 1.26 }  // (mm) relative Y-offset for each nozzle
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -24.5, 1, -3.9 }
