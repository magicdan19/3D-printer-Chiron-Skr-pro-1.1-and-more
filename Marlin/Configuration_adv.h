...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PC5           // Set a custom pin for the controller fan
  #define CONTROLLERFAN_SECS 60             // Duration in seconds for the fan to run after all motors are disabled
  #define CONTROLLERFAN_SPEED 0           // 255 == full speed
 ...
 */
#define E0_AUTO_FAN_PIN PC8 ///dan PE5 avant
#define E1_AUTO_FAN_PIN PE5
#define E2_AUTO_FAN_PIN -1
#define E3_AUTO_FAN_PIN -1
#define E4_AUTO_FAN_PIN -1
#define E5_AUTO_FAN_PIN -1
#define CHAMBER_AUTO_FAN_PIN PG11
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PF10                 // Override the default pin if needed
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  // Override with 'M422 S<index> X<pos> Y<pos>'
    #define Z_STEPPER_ALIGN_XY { {  40, 205 }, { 370,  205 } }
  /**
...
#define LCD_SHOW_E_TOTAL
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define PLR_ENABLED_DEFAULT   false ///dan avant false // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
    #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss
    #define POWER_LOSS_ZRAISE       10 // (mm) Z axis raise on resume (on power loss with UPS)
    #define POWER_LOSS_PIN         PG5 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 4500000
 ...
 */
  ...
  //#define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY    { X_MIN_POS + 100, Y_MIN_POS + 20 }
